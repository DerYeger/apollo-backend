...
public abstract class FOLEntity(public val name: String) {
     ...
     */
    internal var hasBrackets: Boolean = false
     ...
     */
    public abstract fun getRawString(variableAssignments: Map<String, Node>): String
     ...
     */
    public final override fun toString(): String = toString(emptyMap(), false)
     ...
     */
    public fun toString(variableAssignments: Map<String, Node>, wrap: Boolean): String {
